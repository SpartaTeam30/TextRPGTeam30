namespace TextRPGTeam30
{
    public class Shop
    {
        ...
        public Shop(Player player)
        {
            ...
            items = new List<Item>()
            {
                new Item("본 헬름", 30, "방어력", "동물의 뼈를 이용하여 악마의 머리 모양으로 깎아놓은 투구.", 20),
                new Item("아론다이트", 40, "공격력", "원탁의 기사단 단장 란슬롯이 사용했다는 중세 시대의 검.", 30),
                new Item("브리간딘 갑옷", 35, "방어력", "부드러운 가죽이나 천 안쪽에 작은 쇠판을 리벳으로 고정시킨 형태의 갑옷.", 25),
                new Item("건틀렛", 25, "방어력", "철로 만들어진 전투용 장갑.", 15),
                new Item("이더 부츠", 10, "방어력", "가죽으로 만든 목이 긴 부츠.", 7),
                new Item("녹색 망토", 20, "방어력", "숲에서 몸을 숨기고 기습하는 데에 최적인 녹색 망토.", 10)
            };
        }
