namespace TextRPGTeam30
{
    public class Shop
    {
        ...
        public Shop(Player player)
        {
            ...
            {
<<<<<<< Updated upstream
                new Armor("플레이트 헬멧", 10, "방어력", "플레이트 메일과 세트로 이루는 무거운 투구.", 8, 10),
                new Armor("본 헬름", 30, "방어력", "동물의 뼈를 이용하여 악마의 머리 모양으로 깎아놓은 투구.", 20, 3),
                new Weapon("숏 소드", 4, "공격력", "편하게 사용할 수 있는 짧고 가벼운 소드.", 5, 10),
                new Weapon("목검", 5, "공격력", "나무로 만들어진 검술 연습용 목검.", 7, 8),
                new Weapon("커틀러스", 9, "공격력", "해적들이 사용하던 폭이 넓은 검.", 12, 15),
                new Weapon("바스타드 소드", 13, "공격력", "길고 곧은 날이 평평한 손잡이에 연결되어 있는 형태를 가진 검.", 20, 20),
                new Weapon("브로드 소드", 20, "공격력", "기사들이 가장 일반적으로 사용했던 양날검.",30,25),
                new Weapon("아론다이트", 40, "공격력", "원탁의 기사단 단장 란슬롯이 사용했다는 중세 시대의 검.", 40, 40),
                new Armor("합판", 7, "방어력", "나무로 만들어진 방패.", 4, 5),
                new Armor("레더 쉴드", 10, "방어력", "가죽으로 만들어진 원형 방패.", 13, 10),
                new Armor("플레이트 메일", 8, "방어력", "판금과 사슬로 만들어진 갑옷.",5, 7),
                new Armor("스케일 아머", 15, "방어력", "금속 조각을 물고기 비늘처럼 붙여 만든 갑옷.", 10, 12),
                new Armor("브리간딘 갑옷", 35, "방어력", "부드러운 가죽이나 천 안쪽에 작은 쇠판을 리벳으로 고정시킨 형태의 갑옷.", 25, 40),
                new Armor("체인메일 글러브", 14, "방어력", "촘촘한 망사로 만든 글러브.", 8, 10),
                new Armor("건틀렛", 25, "방어력", "철로 만들어진 전투용 장갑.", 15, 20),
                new Armor("파피루스 샌들", 4, "방어력", "무게가 가벼우나 내구성이 약한 신발.", 2, 5),
                new Armor("스파이크 슈즈", 7, "방어력", "눈길에 미끄러지지 않는 미끄럼 방지 신발.", 6, 8),
                new Armor("이더 부츠", 10, "방어력", "가죽으로 만든 목이 긴 부츠.", 9, 12),
                new Armor("천 망토", 12, "방어력", "튼튼한 천이 소재인 몸을 보호하는 망토.",3, 15),
                new HealingPotion("녹색 망토", 20, "방어력", "숲에서 몸을 숨기고 기습하는 데에 최적인 녹색 망토.", 10, 20),
...
=======
                ...
                new HealingPotion("체력 하급포션", 30, "회복력", "HP 30 회복", 15, 1),
                new HealingPotion("체력 중급 포션", 50, "회복력", "HP 50 회복", 25, 1),
                new HealingPotion("체력 상급포션", 100, "회복력", "HP 100 회복", 50, 1),
                new ManaPotion("마나 포션", 30, "회복력", "MP 30 회복", 15, 1),
                new ManaPotion("마나 포션", 50, "회복력", "MP 50 회복", 25, 1),
                new ManaPotion("마나 포션", 100, "회복력", "MP 100 회복", 50, 1)
>>>>>>> Stashed changes
            };
        }
