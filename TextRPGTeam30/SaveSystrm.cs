...
namespace TextRPGTeam30
{
    ...
    public class GameSaveManager
    {
        ...
        private Item CreateItemFromName(string itemName)
        {
            ...
            {
                case "본 헬름":
                    return new Armor("본 헬름", 3, "방어력", "동물의 뼈를 이용하여 악마의 머리 모양으로 깎아놓은 투구.", 100);
                case "아론다이트":
                    return new Weapon("아론다이트", 5, "공격력", "원탁의 기사단 단장 란슬롯이 사용했다는 중세 시대의 검.", 100);
                case "브리간딘 갑옷":
                    return new Armor("브리간딘 갑옷", 15, "방어력", "부드러운 가죽이나 천 안쪽에 작은 쇠판을 리벳으로 고정시킨 형태의 갑옷.", 100);
                case "건틀렛":
                    return new Armor("건틀렛", 2, "방어력", "철로 만들어진 전투용 장갑.", 100);
                case "이더 부츠":
                    return new Armor("이더 부츠", 10, "방어력", "가죽으로 만든 목이 긴 부츠.", 100);
                case "녹색 망토":
                    return new Armor("녹색 망토", 20, "방어력", "숲에서 몸을 숨기고 기습하는 데에 최적인 녹색 망토.", 100);
                case "체력 물약":
